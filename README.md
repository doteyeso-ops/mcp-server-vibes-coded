...
- Free-trial endpoints work with no auth. Paid endpoints settle USDC via x402 (HTTP 402 ΓåÆ pay ΓåÆ retry).
...
the Coinbase x402 facilitator ΓÇö the server forwards a `PAYMENT-SIGNATURE` header if the
